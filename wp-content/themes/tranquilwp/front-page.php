    ...
    <section id="latest-offers">
      <div class="container">
        <div class="row margin-bottom">
          <div class="col-sm-6 col-sm-offset-3">
            <h2><?php _e('Latest Offers', 'tranquilwp'); ?></h2>
...
<!-- btn style "color:white" stopped working from .css when moving page to wordpress -->
            <a href="" class="btn btn-default" roll="button" style="color: white;"><?php _e('Shop Here', 'tranquilwp'); ?></a>
          </div>  <!-- /col --> 
